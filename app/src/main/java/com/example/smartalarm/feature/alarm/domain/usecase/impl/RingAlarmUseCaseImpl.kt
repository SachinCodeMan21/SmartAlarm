...
class RingAlarmUseCaseImpl @Inject constructor(
     ...
     */
    override suspend fun invoke(alarm: AlarmModel): MyResult<AlarmModel, DataError> {
...
//                    }
                ...
                alarmScheduler.scheduleSmartAlarmTimeout(alarm.id, TimeUnit.MINUTES.toMillis(10) + 10000)

                // Return the updated alarm for the foreground notification
                MyResult.Success(updatedAlarm)
            }
