 ...
 * The result returned is a [Result] containing a string that represents how long until the alarm
...
interface PostSaveOrUpdateAlarmUseCase {
     ...
     * @return A [Result] containing a string representing how long until the alarm triggers,
     *         or an empty string if the alarm is disabled.
     */
    operator fun invoke(alarm: AlarmModel): Result<String>
}
