 ...
 * @param alarmManager The [AlarmManager] used to check alarm-related permissions.
 * @param notificationManager The [NotificationManager] used to check notification-related permissions.
 */
